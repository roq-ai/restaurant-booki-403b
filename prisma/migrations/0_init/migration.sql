...
-- AddForeignKey
ALTER TABLE "order" ADD CONSTRAINT "order_delivery_person_id_fkey" FOREIGN KEY ("delivery_person_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
